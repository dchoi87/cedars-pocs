class Navigation {
    ...
    expandSearch() {
        if (this.header.matches(".menu-expanded")) this.closeMenu();
    ...
    expandMenu(target) {
        ...
        if (isMobile) this.header.classList.add("mobile");
        if (section) {
...
document.querySelector(".utility__search-btn").addEventListener("click", function() {
    ...
    if (header.matches(".search-expanded")) nav().closeSearch();
    else nav().expandSearch();
});
document.querySelector(".utility__menu-btn").addEventListener("click", function(event) {
    var header = document.querySelector("header");
    if (header.matches(".menu-expanded")) nav().closeMenu();
    else nav().expandMenu(event.target);
});
